      ...
      <div className="max-w-6xl mx-auto px-6 py-16">
        ...
        <div className="flex flex-col lg:flex-row lg:justify-between gap-12 mb-12">
          ...
          <div className="lg:max-w-xs">
            <Link to="/" className="inline-block text-xl font-bold text-white mb-4">
              グレーモール
            </Link>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 gap-8 lg:gap-16">
            <div>
              ...
              <ul className="space-y-3">
                ...
                <li>
                  <Link to="/law" className="text-sm text-gray-300 hover:text-white transition-colors">
                    特定商取引法に基づく表記
                  </Link>
                </li>
              </ul>
            ...
            <div>
              ...
              <ul className="space-y-3">
                ...
                <li>
                  <Link to="/payments" className="text-sm text-gray-300 hover:text-white transition-colors">
                    取引・支払いについて
                  </Link>
                </li>
                <li>
