    ...
    <Layout>
      <div className="max-w-3xl mx-auto px-4 py-12">
        ...
        <p className="text-gray-600 leading-relaxed mb-8">
          合同会社マイアジアエンターテインメント（以下「当社」といいます。）は、当社が運営する「グレーモール」（<a href="https://graymall.jp/" className="text-blue-600 hover:underline">https://graymall.jp/</a>、以下「本サービス」といいます。）における、利用者の個人情報および利用者情報の取扱いについて、以下のとおりプライバシーポリシー（以下「本ポリシー」といいます。）を定めます。
        </p>
        ...
        <section className="mb-10">
          ...
          <ul className="list-disc pl-6 text-gray-600 leading-relaxed mb-4 space-y-2">
            <li>メールアドレス</li>
            <li>パスワード（当社が直接保存する場合は、適切に暗号化されたもの）</li>
            <li>ニックネーム、表示名等の任意入力情報</li>
            <li>購入履歴、出品履歴、売上・報酬に関する情報</li>
            <li>本人確認に関する情報（必要な場合）</li>
            <li>お問い合わせ内容</li>
            <li>IPアドレス、端末情報、アクセスログ</li>
            <li>Cookieその他の識別子</li>
          </ul>
        ...
        <section className="mb-10">
          ...
          <p className="text-gray-600 leading-relaxed mb-2">当社は、決済、本人確認、システム運用、データ管理等の業務を、第三者に委託する場合があります。</p>
          <p className="text-gray-600 leading-relaxed">この場合、当社は委託先に対して、個人情報の適切な管理を求め、必要かつ適切な監督を行います。</p>
        </section>

        <section className="mb-10">
          <h2 className="text-lg font-semibold text-gray-800 mb-4 pb-2 border-b border-gray-200">第5条（Cookieおよび解析ツール）</h2>
        ...
        <section className="mb-10">
          <h2 className="text-lg font-semibold text-gray-800 mb-4 pb-2 border-b border-gray-200">第6条（広告配信）</h2>
        ...
        <section className="mb-10">
          <h2 className="text-lg font-semibold text-gray-800 mb-4 pb-2 border-b border-gray-200">第7条（個人情報の管理）</h2>
        ...
        <section className="mb-10">
          <h2 className="text-lg font-semibold text-gray-800 mb-4 pb-2 border-b border-gray-200">第8条（開示・訂正・削除等の請求）</h2>
          <p className="text-gray-600 leading-relaxed mb-2">利用者は、当社が保有する自己の個人情報について、開示、訂正、追加、削除、利用停止等を求めることができます。</p>
          <p className="text-gray-600 leading-relaxed mb-2">これらの請求を行う場合は、第10条のお問い合わせ窓口までご連絡ください。</p>
          <p className="text-gray-600 leading-relaxed">当社は、法令に従い、合理的な範囲で対応します。</p>
        </section>

        <section className="mb-10">
          <h2 className="text-lg font-semibold text-gray-800 mb-4 pb-2 border-b border-gray-200">第9条（改定）</h2>
        ...
        <section className="mb-10">
          <h2 className="text-lg font-semibold text-gray-800 mb-4 pb-2 border-b border-gray-200">第10条（お問い合わせ窓口）</h2>
