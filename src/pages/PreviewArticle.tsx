    ...
    return (
      <div className="min-h-screen bg-white">
        <div className="max-w-3xl mx-auto px-6 py-10">
          ...
          <div className="mt-8 prose md:prose-lg prose-slate max-w-none preview-content article-content">
          ...
          {data.paidContent && data.paidContent.trim() && data.paidContent !== '<p></p>' && (
            <>
              ...
              <div className="prose md:prose-lg prose-slate max-w-none preview-content article-content">
